...
|------------|---------|------------------|
| python3 + python-docx | Only `clean_format` until it moves into the runtime; reading, extraction, checks, redlines, compare and rounds need nothing | `python3 -m pip install python-docx` |
