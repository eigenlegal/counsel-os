...
2. Open the DMG in Finder, drag Counsel OS into Applications, eject the image, and open the installed copy. Confirm the app works without the checkout, Bun, Python, a running dev server, or the mounted DMG.
