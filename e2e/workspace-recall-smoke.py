...
with sync_playwright() as p:
    ...
    page.get_by_role('textbox',name='Message Counsel OS',exact=True).fill('Can they recruit our employees?')
    ...
    for width,height in [(1440,1000),(390,844),(320,740)]:
        ...
        page.get_by_text('How Counsel OS searched',exact=True).click()
