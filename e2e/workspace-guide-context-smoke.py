...
with sync_playwright() as p:
    ...
    page.get_by_role('textbox', name='Message Counsel OS', exact=True).fill('Synthetic guide fixture: plan a review of staff location monitoring.')
    ...
    panel.locator('summary').filter(has_text='Records available to Counsel OS').click()
