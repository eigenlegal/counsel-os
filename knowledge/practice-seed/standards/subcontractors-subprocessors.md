...
**We won't accept:** No consent or notice required, no subprocessor list or notification of changes, vendor disclaiming liability for subcontractor performance, no flowdown of obligations, or customer data processed by unnamed subprocessors in unspecified jurisdictions.
**Auto-escalate:** Vendor refuses consent or notice for subcontractor changes; disclaims subcontractor liability; no flowdown of confidentiality/security/data protection; no objection right with meaningful consequence; subprocessors in jurisdictions without adequate data protection; no vetting process; customer data shared with unidentified subprocessors.
