...
**We won't accept:** Notices effective only by physical mail to a single address, posting to vendor's website constituting notice, effectiveness upon mailing without deemed receipt, no obligation to maintain current addresses, or termination by verbal notice.
**Auto-escalate:** Formal notices (termination, breach) by email only with no delivery confirmation; effectiveness upon sending not receipt; vendor can send notices by posting to website; no designated contacts; no obligation to update notice information; inconsistent notice provisions across MSA, DPA, and SOW.
