...
**We won't accept:** Cap below 6 months of fees, entirely one-sided limitation favoring vendor, no carve-outs for data breach or IP indemnification, vendor excluding all liability for data loss or security incidents, or consequential damages exclusion that is not mutual.
**Auto-escalate:** Vendor demands unlimited customer liability (non-mutual); cap below 6 months or below total contract value; no carve-outs for IP, data breach, or confidentiality; cap based on "paid" not "paid or payable"; vendor excludes data breach liability; unverifiable insurance for uncapped obligations.
