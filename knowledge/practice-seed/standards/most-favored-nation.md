...
**We won't accept:** Broad MFN covering all terms across all customers regardless of comparability, retroactive price adjustments for the entire term, no definition of "comparable customer," MFN extending indefinitely post-termination, or reverse MFN restricting customer's purchasing decisions.
**Auto-escalate:** MFN covers all terms regardless of comparability; retroactive adjustments for the entire term; no "comparable customer" definition; MFN extends beyond the contract term; reverse MFN restricts customer; no verification mechanism; MFN triggered by promotional discounts to dissimilar customers.
