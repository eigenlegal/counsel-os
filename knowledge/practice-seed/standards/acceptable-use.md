...
**We won't accept:** Vague restrictions that could encompass lawful business activity, immediate termination without notice or cure for any AUP violation, vendor modifying AUP at any time without notice, or restrictions on using competing products.
**Auto-escalate:** AUP restrictions broad enough to cover lawful business activity; immediate termination for any violation without notice; unilateral AUP modification without notice; anti-competitive restrictions; no security testing carve-out.
