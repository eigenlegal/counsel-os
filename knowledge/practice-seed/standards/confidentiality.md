...
**We won't accept:** One-sided obligations, duration under 2 years, no trade secret protection, broad residuals clause permitting unrestricted use of ideas/concepts/know-how, no return/destruction obligation, or no notice for compelled disclosure.
**Auto-escalate:** Entirely one-sided obligations; duration under 2 years; no trade secret carve-out; unrestricted residuals clause; no return/destruction obligation; no compelled disclosure notice; no injunctive relief acknowledgment.
