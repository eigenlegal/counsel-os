...
**We won't accept:** Foreign governing law with no nexus to either party, mandatory litigation in an inconvenient distant jurisdiction, no injunctive relief carve-out, waiver of all equitable remedies, or conflicting dispute resolution mechanisms across related agreements.
**Auto-escalate:** Governing law in an unrelated foreign jurisdiction; mandatory arbitration in an inconvenient venue with no virtual option; no injunctive relief carve-out; proceedings required in multiple jurisdictions; jury trial waiver without arbitration clause; class action waiver in consumer-facing agreements.
