...
**We won't accept:** Entirely one-sided assignment rights, free assignment to competitors without consent, automatic termination on change of control, no written assumption of obligations by assignee, or consent withheld in sole discretion.
**Auto-escalate:** Vendor can freely assign but customer cannot; no change of control provision; unrestricted assignment to competitors; automatic termination on change of control; no written assumption of obligations; anti-assignment clause capturing IPOs.
