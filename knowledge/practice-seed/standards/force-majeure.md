...
**We won't accept:** One-sided force majeure (vendor only), excusing payment obligations, including events within the party's control (financial difficulties, staffing, market changes), no termination right regardless of duration, or including economic hardship.
**Auto-escalate:** Force majeure excuses payment; no termination right after extended duration; events within party's control included; no mitigation or notice requirement; entirely one-sided; pandemic exclusion in post-COVID agreement; economic hardship included.
