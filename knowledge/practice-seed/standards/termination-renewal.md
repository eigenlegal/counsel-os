...
**We won't accept:** No termination for cause right, auto-renewal into multi-year terms with under 30 days non-renewal notice, vendor-only termination for convenience, early termination fees exceeding remaining committed value, or no data return/deletion obligations.
**Auto-escalate:** No termination for cause right; cure period exceeds 60 days; auto-renewal locks into multi-year terms with under 30 days notice; no change of control termination right; early termination penalties exceed remaining fees; no data return/deletion; vendor can terminate for convenience but customer cannot.
