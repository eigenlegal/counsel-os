...
**We won't accept:** Vendor claiming ownership of customer data or customer-generated content, no license to customer for vendor IP in deliverables, vendor using customer-specific work for other clients without restriction, or vendor claiming rights to AI-generated outputs using customer data.
**Auto-escalate:** Vendor claims customer data ownership; no license for vendor IP in deliverables; vendor owns custom work without adequate license; no "hereby assigns" language; vendor reuses customer-specific deliverables freely; IP assignment doesn't survive termination; unaddressed AI output ownership.
