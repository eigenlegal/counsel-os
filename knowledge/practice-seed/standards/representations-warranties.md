...
**We won't accept:** All warranties disclaimed ("as-is"), no non-infringement warranty, no compliance-with-law warranty, vendor disclaiming conformity to its own documentation, or no warranty remedy of any kind.
**Auto-escalate:** Vendor disclaims ALL warranties; no non-infringement warranty; no compliance-with-law warranty; vendor disclaims documentation conformity; no warranty remedy; "as-is, where-is" language for a paid product; warranties only as of effective date (not ongoing); no malware/disabling code warranty.
