...
**We won't accept:** Entirely one-sided indemnification (customer only), vendor refusing IP infringement indemnity, fully uncapped indemnification for broad categories, or vendor controlling settlement with right to admit liability on customer's behalf without consent.
**Auto-escalate:** Indemnification entirely one-sided; vendor refuses IP infringement indemnity; no defense obligation; first-party losses covered without limits; fully uncapped with no insurance backing; no notice/cooperation requirements; settlement allows admitting liability without consent.
