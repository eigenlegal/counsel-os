...
**We won't accept:** No audit rights of any kind, vendor refusing to provide security certifications, audit scope excluding security and data handling, vendor discretion to deny audit requests, or no remediation obligations.
**Auto-escalate:** No audit rights provided; vendor refuses SOC 2/ISO 27001 or equivalent; audit scope excludes security or data handling; vendor has sole discretion to deny audits; no remediation obligation; one-sided audit rights.
