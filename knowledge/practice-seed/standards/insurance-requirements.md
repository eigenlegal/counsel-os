...
**We won't accept:** No cyber liability insurance for a data-processing vendor, CGL or Professional Liability below $1M, vendor refusing to provide certificates, no tail coverage for claims-made policies, or self-insured retention above $500K.
**Auto-escalate:** Vendor refuses cyber liability while processing personal data; coverage materially below minimums relative to risk; no E&O for a services engagement; refuses to provide certificates; no post-termination tail coverage; one-sided insurance requirements; SIR exceeds $500K without verified financial capacity.
