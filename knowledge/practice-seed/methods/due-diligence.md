...
Use when conducting legal due diligence on a target company in connection with a potential acquisition, merger, investment, or strategic partnership. Also applicable to vendor due diligence for critical/strategic vendor relationships.

## Workstream Organization

| Workstream | Key Law Areas |
|---|---|
| Corporate/Governance | Corporate law |
| Contracts | Assignment and change-of-control positions |
| IP | IP and technology law |
| Litigation & Disputes | Litigation law |
| Employment | Employment law |
| Regulatory/Compliance | Varies by industry |
| Data Privacy & Security | Data privacy, cybersecurity law |
| Real Estate & Assets | Real estate law |
| Tax | Tax law |
| Insurance | Insurance law |
| Environmental | Environmental/ESG law |

## Scope by Deal Type

- **Full Acquisition:** All workstreams active. Complete checklist below.
...
- **Vendor Due Diligence:** Focus on Data Privacy, Security, Contracts, Financial stability, Insurance. Use vendor onboarding method instead of full DD checklist.
...
| **Moderate** | Issues requiring post-closing remediation within 90 days | Manageable exposure, clear remediation path |
| **Low** | Noted but manageable issues | No material financial impact |

Quantify financial exposure where possible using ranges (low/likely/high).

## Deal Protection Mechanisms

Map each finding to the appropriate mechanism:

- **Representation & warranty** -- standard coverage for identified risk areas
- **Special indemnity** -- specific protection for known issues exceeding normal risk
- **Escrow/holdback** -- typically 10-15% of purchase price for 12-18 months
- **Price adjustment** -- reduce purchase price for quantified liabilities
- **Closing condition** -- consents obtained, no material adverse change, regulatory approvals
- **Post-closing covenant** -- remediation obligations (e.g., "cure all identified data privacy gaps within 90 days post-closing")
