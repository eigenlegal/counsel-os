...
Use when a stakeholder or executive requests legal analysis on a specific question, risk, or proposed course of action. Memos document analysis and recommendations for the record and may be subject to attorney-client privilege.

## Memo Types

- **Quick-Turn Advice:** Single question, clear answer, low complexity. Deliver as a structured email. Scope: 1-2 pages, 2-4 hours.
- **Standard Memo:** Moderate complexity, multiple considerations. Full IRAC format. Scope: 3-6 pages, 1-2 days.
- **Comprehensive Analysis:** Novel issue, multiple jurisdictions, significant business impact. Deep research required. Scope: 8-15 pages, 3-7 days. Consider engaging outside counsel.

## IRAC Framework

Structure every analysis using Issue, Rule, Application, Conclusion:

**I -- Issue:** State the specific legal issue as a question. ("Whether the Company's proposed data sharing arrangement constitutes a 'sale' under CCPA.")
...
2. **Counsel OS law files:** Synthesized legal frameworks from the knowledge system
...
5. **Internal precedent:** Prior memos in entity files, established positions in practice standards
...
Use consistently when assessing likelihood of adverse outcomes:
...
- Keep the memo to the minimum length needed for thoroughness
