...
Use when preparing for or conducting contract negotiations. Covers both initial deals and renegotiations of existing agreements.

## Tier Prioritization

Categorize all open issues before negotiating:

- **Tier 1 -- Must Have:** Deal-breakers if not resolved. Non-negotiable legal or business requirements. Examples: liability cap within acceptable range, data protection compliance, IP ownership of custom work. If the counterparty cannot accept any Tier 1 item, escalate to senior leadership before conceding.
- **Tier 2 -- Important:** Strong preference but room for creative solutions. Examples: SLA levels, termination convenience rights, indemnification scope. Fallback positions available from position files.
- **Tier 3 -- Nice to Have:** Preferred but expendable as trade currency. Examples: governing law preference, audit frequency, notice periods, force majeure breadth. Plan which to concede and in what order.

## BATNA Framework

Define before negotiations begin:
...
- **Reservation Price:** The worst acceptable outcome on each key issue. Document before negotiation begins -- do not let it shift under pressure.
...
Define the specific combination of terms that makes the deal unacceptable. A deal is a walk-away if:
1. Any single Tier 1 item hits the walk-away point, OR
2. Three or more Tier 2 items hit their walk-away points simultaneously.

Document this threshold and get business owner sign-off before starting negotiations.
...
When preparing the redline:
1. Work section by section, marking changes in track changes
2. For each RED item: propose complete replacement language from the clause library; add a comment citing the specific concern
...
5. Review the redline in full before sending. Verify changes do not create internal inconsistencies (e.g., changing a definition in one place but not another)
...
- Include selected Tier 3 positions as negotiation currency -- plan to concede 2-3 early to build goodwill
- Pull proposed language from clause library files where available. Use proven language rather than drafting from scratch.
- Frame comments in terms of mutual benefit or market standard, not "our policy requires"
