...
## Prerequisites
- Load position file: `practice/standards/confidentiality.md`
- Load clause library: `practice/library/ip-and-confidentiality.md`
- Load screening checklist: `practice/methods/nda-screening.md`
