...
Relevant when supporting board of directors meetings, committee meetings, governance matters, or corporate actions requiring board or shareholder approval. Covers board materials, corporate minutes, written consents, and fiduciary duty considerations.

## Governance Action Approval Requirements
...
| Equity issuance (options, warrants, shares) | Board approval + stockholder approval if >20% dilution | Certificate of incorporation, securities law |
| M&A transaction | Board approval + stockholder approval | DGCL Section 251/271 |
| Officer appointment/removal | Board approval | Bylaws |
| Annual budget | Board approval | Bylaws or board practice |
| Related-party transaction | Disinterested director/committee approval | DGCL Section 144 |
...
**Quorum and voting:** Check bylaws for quorum requirements (typically majority of directors). Determine vote threshold (majority of quorum, majority of full board, supermajority, unanimous). Check for contractual consent requirements (investor consent rights under voting agreements or investor rights agreements).
...
**Notice requirements:** Review bylaws for timing, form, and content. Delaware default: oral or written notice not less than 2 days before the meeting. For special meetings, state the purpose(s) — actions are limited to the stated purposes.

## Board Package Standard Contents
...
## Resolution Drafting Guidance

- Include **WHEREAS** recitals providing context and rationale (these support the business judgment rule)
- State the action clearly: **"RESOLVED, that the Board of Directors hereby approves..."**
...
**Include:**
- Date, time, location, attendees (with titles), quorum confirmation
- Each matter discussed and the action taken (approved, tabled, deferred, no action required)
- Vote results: "Upon motion duly made, seconded, and unanimously approved" or note specific dissents/abstentions
- Conflicts of interest and recusals with the process followed
- Delegations of authority granted
...
- Follow-up items with assigned responsibilities and deadlines

**Do NOT include:**
- Detailed discussion of legal advice
- Individual director comments attributable by name (unless dissenting)
- Negotiation strategy
- Speculative business projections

**Review process:** Draft within 5 business days. Circulate to chair and corporate secretary within 10 business days. Present for formal approval at the next regular meeting. File approved minutes in the corporate minute book.

## Written Consent Requirements

### Delaware Corporations
- Verify bylaws and certificate of incorporation permit action by written consent (Delaware default: permitted unless certificate prohibits it)
- Written consent must be signed by the minimum number of votes required for the action at a meeting at which all directors entitled to vote were present (typically majority of the full board, not just a quorum)
- Effective date: when the required number of signatures is obtained (not when the last signature is collected if not unanimous)

### Written Consent Document Structure
...
## Annual Governance Review Checklist

- Review and update the delegation of authority matrix (spending limits, hiring authority, contract signing authority)
- Verify D&O insurance coverage and limits (adequate for company stage and risk profile)
- Review board and committee charters — update for changes in composition, mandate, or regulatory requirements
...
- File required annual reports and franchise tax payments:
