...
Relevant when handling involuntary termination of an individual employee, a reduction in force (RIF), or negotiation of an executive separation. Covers legal analysis, documentation, and process to minimize litigation risk and ensure compliance with employment law.
...
## Proceed-or-Hold Decision Framework

**Hold if:**
1. The employee has engaged in recent protected activity (filed complaint, EEOC charge, workers' comp claim, FMLA leave, whistleblower report) within the past 6 months — consult employment counsel before proceeding.
2. The employee is a member of a protected class AND the termination documentation is weak — strengthen documentation first.
3. The employee is on active medical leave, FMLA, military leave, or workers' compensation leave — assess whether the termination can legally proceed.
...
Many states have enacted bans or restrictions — California, Colorado, Illinois, Minnesota, New York, Oregon, Washington, and the FTC rule (if in effect). Key considerations:
...
- If unenforceable in the jurisdiction, do not rely on it. If enforceable, include a reminder and affirmation in the separation agreement.

## Federal WARN Act Triggers and Thresholds

**Applicability:** Employers with 100+ employees

**Triggering events:**
- Plant closing: 50+ employees at a single site
- Mass layoff: 50+ employees constituting 33% of site workforce, or 500+ employees regardless of percentage

**Requirements:** 60 days written notice to affected employees, state dislocated worker unit, and local government

**Exceptions:** Faltering company, unforeseeable business circumstances, natural disaster

**Consequence of non-compliance:** Employer is liable for back pay and benefits for the notice period shortfall.

## State Mini-WARN Thresholds

Many states have lower thresholds and longer notice periods:
- California: 75 employees
- New York: 25 employees (90-day notice period)
- Illinois: 75 employees
- New Jersey: 100 employees
...
The Older Workers Benefit Protection Act imposes specific requirements on any release of ADEA claims:

**All terminations (age 40+):**
...
**Group termination (RIF):** 45-day consideration period + 7-day revocation period, plus disclosure of:
- (a) the class, unit, or group covered by the program
- (b) eligibility factors
- (c) time limits
- (d) job titles and ages of all individuals eligible or selected for the program in the decisional unit
- (e) ages of all individuals in the same job classification or organizational unit who are not eligible or selected

## Separation Agreement Standard Components
...
## Severance Calculation Guidance
...
- Vesting schedule and post-termination exercise period (typically 90 days for ISOs, may be longer for NSOs)
- Unvested equity: forfeited upon termination (unless acceleration negotiated in separation agreement)
- Accrued but unused PTO: check state law (California, Illinois, Massachusetts, and others require payout)
- Unpaid commissions or bonuses: check the plan for post-termination payment obligations
- Deferred compensation (Section 409A): ensure separation payment timing complies with 409A

## State Final Paycheck Timing

State law governs when the final paycheck must be delivered:
- California: same day as termination
- Most other states: next regular payday

Check the specific state(s) where affected employees are located. Also file necessary notifications: unemployment insurance, benefits carriers, equity plan administrator.
