...
- **Visa Integrity Risk Program (VIRP):** Excessive fraud monitoring with escalating thresholds — identification: 75 bps fraud-to-sales ratio + $50K fraud amount; early warning: 150 bps; standard: 180 bps; excessive: 300 bps. Non-compliance triggers monthly assessments and potential processing restrictions.
...
- **Excessive Chargeback Programs:**
  - **Visa Dispute Monitoring Program (VDMP):** Standard threshold: 100 disputes + 0.9% dispute ratio per month. Excessive threshold: 1,000 disputes + 1.8% ratio. Monthly non-compliance assessments escalate from $50/dispute to $100/dispute after 12+ months.
  - **Mastercard Excessive Chargeback Program (ECP):** Threshold: 100 chargebacks + 1.0% chargeback-to-transaction ratio for 2 consecutive months. Excessive: 300 chargebacks + 1.5% ratio. Assessments: $1,000-$200,000/month depending on tier and duration.
...
- **RTP Network (The Clearing House):** Launched 2017. $1,000,000 per-transaction limit. 24/7/365 availability. Credit-push only (no debit pull). Irrevocable — no recalls, only request-for-return (which the receiving institution may decline). 300+ participating financial institutions.
- **FedNow (Federal Reserve):** Launched July 2023. $500,000 default per-transaction limit (adjustable down to $100,000 minimum by participating institution). 24/7/365. Credit-push only. 1,000+ participating institutions. Request for Payment (RfP) feature allows payees to request funds from payers.
