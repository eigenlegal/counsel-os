...
**Regulatory references:** GDPR, General Data Protection Regulation, CCPA, California Consumer Privacy Act, CPRA, California Privacy Rights Act, VCDPA, CPA (Colorado Privacy Act), CTDPA, MODPA (Maryland), TDPSA (Texas), HIPAA, FERPA, COPPA, GLBA, PIPEDA, LGPD, POPIA, PDPA, UK GDPR, UK Data Protection Act 2018, Data (Use and Access) Act 2025, ePrivacy Directive, Privacy Shield, EU-US Data Privacy Framework, APEC CBPR, PIPL, APPI, PIPA, DPDPA, Law 25 (Quebec)
...
- **us-state-privacy.md** — State-by-state comparison: scope thresholds, consumer rights, enforcement models, sensitive data definitions; Maryland MODPA's strict minimization model; 2025-26 Connecticut and Montana amendments
...
- **coppa.md** — Children's data: under-13 threshold, verifiable parental consent, operator obligations, 2025 amended COPPA Rule (binding since April 2026), FTC enforcement
...
- **cross-border-transfers.md** — Transfer mechanisms: SCCs (2021), adequacy decisions (UK renewed to 2031; Brazil added 2026), Schrems II supplementary measures, TIAs, Brazilian SCCs (2024), APEC CBPR
...
- **glba-privacy.md** — GLBA Financial Privacy Rule, FTC Safeguards Rule (2023 amendments; 30-day FTC breach notification for 500+ consumers since May 2024), GLBA-CCPA interaction (entity vs. data-level exemption), GLBA-GDPR interaction
