...
authorities:
  ...
  - cite: "16 C.F.R. Part 464"
    title: "Rule on Unfair or Deceptive Fees, effective May 12, 2025"
  ...
  - cite: "Regulation (EU) 2022/2065, Article 25"
    title: "Digital Services Act dark pattern prohibition"
...
- **Consequence**: FTC enforcement actions have resulted in consent orders, civil penalties (up to $53,088 per violation, indexed annually), consumer refunds, and injunctive relief requiring redesign of interfaces. Notable enforcement actions include Fortnite/Epic Games ($520 million total settlement in 2022, partly for dark pattern charges targeting children), Age of Learning/ABCmouse ($10 million in 2020 for deceptive cancellation practices), Credit Karma ($3 million for misleading "pre-approved" credit claims), and FTC v. Amazon ($2.5 billion ROSCA settlement in September 2025 — a $1 billion civil penalty plus $1.5 billion in redress — over manipulative Prime enrollment and cancellation flows).
...
- **Threshold**: The FTC's 2024 Click-to-Cancel Rule would have set a bright-line test — cancellation at least as easy as sign-up — but the Eighth Circuit vacated the rule in its entirety before its core provisions were enforced (Custom Communications, Inc. v. FTC, No. 24-3137, July 8, 2025). Obstruction analysis now runs through ROSCA's "simple mechanisms" requirement and Section 5 deception/unfairness, plus state auto-renewal laws (California's ARL requires online click-to-cancel and, per AB 2863, prohibits obstructing or delaying cancellation). Requiring a phone call to cancel an online sign-up, multi-step cancellation mazes, and mandatory "save" offers the consumer cannot easily bypass remain leading enforcement theories.
- **Consequence**: FTC enforcement under ROSCA and Section 5 — the 2025 Amazon Prime settlement is the leading example — plus state AG enforcement. Obstruction in cancellation flows is one of the most actively enforced dark pattern categories.
...
- **Threshold**: The FTC and state laws require that material costs be disclosed before the consumer provides payment information. Drip pricing — where mandatory fees are revealed incrementally — is now prohibited for live-event tickets and short-term lodging by the FTC's Rule on Unfair or Deceptive Fees (16 C.F.R. Part 464, effective May 12, 2025), which requires upfront, prominent total-price disclosure including all mandatory fees; outside those sectors, drip pricing is pursued under ordinary Section 5 deception analysis and state UDAP/pricing-transparency laws. Pre-checked add-ons that increase the total cost are considered deceptive if not clearly and conspicuously disclosed.
...
- **Consumer Protection — Auto-Renewal**: Dark pattern prohibitions in cancellation flows directly implement ROSCA and state auto-renewal laws (the FTC's 2024 Click-to-Cancel Rule was vacated in 2025; California's ARL now carries the strictest click-to-cancel requirements). Obstruction patterns in cancellation are the most actively enforced category. See `auto-renewal.md`.
...
- [FTC Negative Option Rule rulemaking](https://www.ftc.gov/legal-library/browse/rules/negative-option-rule) — Status of the 2024 Click-to-Cancel rule (vacated by the Eighth Circuit, July 2025) and the 2026 ANPRM.
...
- [16 C.F.R. Part 465 — Rule on the Use of Consumer Reviews and Testimonials](https://www.ecfr.gov/current/title-16/chapter-I/subchapter-D/part-465) — Fake-reviews rule, effective October 21, 2024.
