...
The owner-approved [Counsel OS 0.1.0 preview, build 12](https://github.com/eigenlegal/counsel-os/releases/tag/desktop-v0.1.0-preview.12) provides an Apple silicon Mac installer as a GitHub Release asset. This build adds batch review across imported practice positions, methods, reusable language and lessons, and cleans up imported titles and previews without changing original files. It also includes build 10's Claude Code sign-in and automatic model-list fixes. This is an experimental, ad-hoc-signed preview, **not Apple-notarized**; macOS may refuse a downloaded copy. It is not the production release or an automatic update channel. See its release notes for installation, verification, and known limitations.
...
In **Practice → Review imported material**, approve unchanged practice-wide imports in batches of up to 50. The dialog loads the remaining items after each approval. Positions, methods, reusable language and lessons keep their separate roles; nothing is approved automatically. Revised proposals and matter-specific material still need individual review.
